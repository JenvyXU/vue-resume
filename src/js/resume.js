            ...
            <section class="skills">
                ...
                <ul>
                    <li v-for="skill,index in displayResume.skills">
                        ...
                        <span v-if="index>=4&&mode==='edit'" @click="removeSkill(index)" class="remove">X</span>
                    </li>
                    <li v-if="mode==='edit'" class="add"><span @click="addSkill">添加</span></li>
                </ul>
            </section>
            <section class="projects">
                ...
                <ol>
                    ...
                    <p>
                        ...
                        <span v-if="index>=2&&mode==='edit'" @click="removeProject" class="remove">X</span>
                </li>
